  ...
  return <section id="faq" className="py-20 bg-white">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="text-center mt-12 fade-in">
          ...
          <a href={`https://wa.me/554198943285?text=${encodeURIComponent('Olá, gostaria de esclarecer algumas dúvidas sobre parto humanizado')}`} target="_blank" rel="noopener noreferrer" className="btn-primary">Agende sua consulta.</a>
        </div>
      </div>
    </section>;
};
