    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass-header">
      <div className="container mx-auto h-20 flex justify-between items-center max-w-7xl px-[17px] py-0 my-[3px]">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a href="https://wa.me/554198943285" target="_blank" rel="noopener noreferrer" className="btn-primary flex items-center gap-2">
            <Calendar size={16} />
            Agendar Consulta
          </a>
        </nav>
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-lg shadow-lg">
          <div className="container mx-auto px-6 py-6 flex flex-col space-y-4">
            ...
            <a href="https://wa.me/554198943285" target="_blank" rel="noopener noreferrer" className="btn-primary flex items-center justify-center gap-2 mt-4">
              <Calendar size={16} />
              Agendar Consulta
            </a>
          </div>
