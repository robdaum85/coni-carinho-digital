          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 p-4 bg-white rounded-lg shadow-sm">
                ...
                <div>
                  <h4 className="font-playfair font-medium text-gray-900">E-mail</h4>
                  <a 
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Como posso ajudá-la?"
                />
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  type="button"
                  onClick={handleWhatsApp}
                  className="bg-green-500 text-white px-6 py-3 rounded-full font-medium transition-all duration-300 hover:bg-green-600 hover:scale-105 flex items-center justify-center gap-2"
                >
