      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-sm opacity-90 text-center md:text-left font-inter leading-relaxed">Obstetrícia humanizada e de alto risco em Curitiba.</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="space-y-3">
              <a href="https://wa.me/5541999999999" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:opacity-80 transition-opacity group">
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://wa.me/5541999999999" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-10 h-10 bg-white rounded-full flex items-center justify-center hover:scale-110 transition-transform">
